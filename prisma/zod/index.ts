...
export const UserSchema = z.object({
  id: z.string().cuid(),
  name: z.string().trim().min(1, { message: "Надто коротко! Поле мусить мати хоча б 1 символ" }).max(255, { message: "Надто багато! Поле мусить мати не більше 255 символів" }),
  email: z.string().trim().email({ message: 'Ви впевнені, що email вірний?' }).min(1, { message: "Надто коротко! Поле мусить мати хоча б 1 символ" }).max(255, { message: "Надто багато! Поле мусить мати не більше 255 символів" }),
...
export const IssueSchema = z.object({
  ...
  title: z.string().trim().min(1, { message: "Надто коротко! Поле мусить мати хоча б 1 символ" }).max(255, { message: "Надто багато! Поле мусить мати не більше 255 символів" }),
...
export const CommentSchema = z.object({
  id: z.string().cuid(),
  body: z.string().trim().min(1, { message: "Надто коротко! Поле мусить мати хоча б 1 символ" }).max(4500, { message: "Надто багато! Поле мусить мати не більше 4500 символів" }),
  isEdited: z.boolean(),
  issueId: z.string(),
  isSystem: z.boolean(),
...
export const GithubWikiFileSchema = z.object({
  id: z.string().cuid(),
  path: z.string().trim().min(1, { message: "Надто коротко! Поле мусить мати хоча б 1 символ" }).max(255, { message: "Надто багато! Поле мусить мати не більше 255 символів" }),
  previousPath: z.string().trim().min(1, { message: "Надто коротко! Поле мусить мати хоча б 1 символ" }).max(255, { message: "Надто багато! Поле мусить мати не більше 255 символів" }).nullable(),
...
export const NotificationSchema = z.object({
  id: z.string().cuid(),
  message: z.string().trim().min(1, { message: "Надто коротко! Поле мусить мати хоча б 1 символ" }).max(500, { message: "Надто багато! Поле мусить мати не більше 500 символів" }),
...
.and(z.object({
  ...
  email: z.string().trim().email({ message: 'Ви впевнені, що email вірний?' }).min(1, { message: "Надто коротко! Поле мусить мати хоча б 1 символ" }).max(255, { message: "Надто багато! Поле мусить мати не більше 255 символів" }).optional(),
  AND: z.union([ z.lazy(() => UserWhereInputSchema),z.lazy(() => UserWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => UserWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => UserWhereInputSchema),z.lazy(() => UserWhereInputSchema).array() ]).optional(),
  name: z.union([ z.lazy(() => StringFilterSchema),z.string().trim().min(1, { message: "Надто коротко! Поле мусить мати хоча б 1 символ" }).max(255, { message: "Надто багато! Поле мусить мати не більше 255 символів" }) ]).optional(),
  emailVerified: z.union([ z.lazy(() => DateTimeNullableFilterSchema),z.coerce.date() ]).optional().nullable(),
  image: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  createdAt: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
  updatedAt: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
...
.and(z.object({
  ...
  title: z.union([ z.lazy(() => StringFilterSchema),z.string().trim().min(1, { message: "Надто коротко! Поле мусить мати хоча б 1 символ" }).max(255, { message: "Надто багато! Поле мусить мати не більше 255 символів" }) ]).optional(),
  description: z.union([ z.lazy(() => BytesNullableFilterSchema),z.instanceof(Buffer) ]).optional().nullable(),
  status: z.union([ z.lazy(() => EnumIssueStatusFilterSchema),z.lazy(() => IssueStatusSchema) ]).optional(),
  priority: z.union([ z.lazy(() => EnumIssuePriorityFilterSchema),z.lazy(() => IssuePrioritySchema) ]).optional(),
  workspaceId: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
...
.and(z.object({
  ...
  OR: z.lazy(() => CommentWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => CommentWhereInputSchema),z.lazy(() => CommentWhereInputSchema).array() ]).optional(),
  body: z.union([ z.lazy(() => StringFilterSchema),z.string().trim().min(1, { message: "Надто коротко! Поле мусить мати хоча б 1 символ" }).max(4500, { message: "Надто багато! Поле мусить мати не більше 4500 символів" }) ]).optional(),
  isEdited: z.union([ z.lazy(() => BoolFilterSchema),z.boolean() ]).optional(),
  issueId: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  isSystem: z.union([ z.lazy(() => BoolFilterSchema),z.boolean() ]).optional(),
  authorId: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
...
.and(z.object({
  ...
  OR: z.lazy(() => GithubWikiFileWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => GithubWikiFileWhereInputSchema),z.lazy(() => GithubWikiFileWhereInputSchema).array() ]).optional(),
  path: z.union([ z.lazy(() => StringFilterSchema),z.string().trim().min(1, { message: "Надто коротко! Поле мусить мати хоча б 1 символ" }).max(255, { message: "Надто багато! Поле мусить мати не більше 255 символів" }) ]).optional(),
  previousPath: z.union([ z.lazy(() => StringNullableFilterSchema),z.string().trim().min(1, { message: "Надто коротко! Поле мусить мати хоча б 1 символ" }).max(255, { message: "Надто багато! Поле мусить мати не більше 255 символів" }) ]).optional().nullable(),
...
.and(z.object({
  ...
  OR: z.lazy(() => NotificationWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => NotificationWhereInputSchema),z.lazy(() => NotificationWhereInputSchema).array() ]).optional(),
  message: z.union([ z.lazy(() => StringFilterSchema),z.string().trim().min(1, { message: "Надто коротко! Поле мусить мати хоча б 1 символ" }).max(500, { message: "Надто багато! Поле мусить мати не більше 500 символів" }) ]).optional(),
  issueId: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  isRead: z.union([ z.lazy(() => BoolFilterSchema),z.boolean() ]).optional(),
  isEmailSent: z.union([ z.lazy(() => BoolFilterSchema),z.boolean() ]).optional(),
  senderId: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
...
export const UserUpdateInputSchema: z.ZodType<Prisma.UserUpdateInput> = z.object({
  ...
  name: z.union([ z.string().trim().min(1, { message: "Надто коротко! Поле мусить мати хоча б 1 символ" }).max(255, { message: "Надто багато! Поле мусить мати не більше 255 символів" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  email: z.union([ z.string().trim().email({ message: 'Ви впевнені, що email вірний?' }).min(1, { message: "Надто коротко! Поле мусить мати хоча б 1 символ" }).max(255, { message: "Надто багато! Поле мусить мати не більше 255 символів" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const IssueUpdateInputSchema: z.ZodType<Prisma.IssueUpdateInput> = z.object({
  ...
  title: z.union([ z.string().trim().min(1, { message: "Надто коротко! Поле мусить мати хоча б 1 символ" }).max(255, { message: "Надто багато! Поле мусить мати не більше 255 символів" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const CommentUpdateInputSchema: z.ZodType<Prisma.CommentUpdateInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  body: z.union([ z.string().trim().min(1, { message: "Надто коротко! Поле мусить мати хоча б 1 символ" }).max(4500, { message: "Надто багато! Поле мусить мати не більше 4500 символів" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const GithubWikiFileCreateInputSchema: z.ZodType<Prisma.GithubWikiFileCreateInput> = z.object({
  id: z.string().cuid().optional(),
  path: z.string().trim().min(1, { message: "Надто коротко! Поле мусить мати хоча б 1 символ" }).max(255, { message: "Надто багато! Поле мусить мати не більше 255 символів" }),
  previousPath: z.string().trim().min(1, { message: "Надто коротко! Поле мусить мати хоча б 1 символ" }).max(255, { message: "Надто багато! Поле мусить мати не більше 255 символів" }).optional().nullable(),
  githubRepositoryId: z.number().int(),
...
export const GithubWikiFileUpdateInputSchema: z.ZodType<Prisma.GithubWikiFileUpdateInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  path: z.union([ z.string().trim().min(1, { message: "Надто коротко! Поле мусить мати хоча б 1 символ" }).max(255, { message: "Надто багато! Поле мусить мати не більше 255 символів" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  previousPath: z.union([ z.string().trim().min(1, { message: "Надто коротко! Поле мусить мати хоча б 1 символ" }).max(255, { message: "Надто багато! Поле мусить мати не більше 255 символів" }),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const NotificationUpdateInputSchema: z.ZodType<Prisma.NotificationUpdateInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  message: z.union([ z.string().trim().min(1, { message: "Надто коротко! Поле мусить мати хоча б 1 символ" }).max(500, { message: "Надто багато! Поле мусить мати не більше 500 символів" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
